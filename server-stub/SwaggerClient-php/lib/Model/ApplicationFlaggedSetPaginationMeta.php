...
/**
 * ApplicationFlaggedSetPaginationMeta Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ApplicationFlaggedSetPaginationMeta implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ApplicationFlaggedSetPaginationMeta';
...
'total_flagged' => 'getTotalFlagged'    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['total_flagged'] = isset($data['total_flagged']) ? $data['total_flagged'] : null;
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['total_flagged'] === null) {
            $invalidProperties[] = "'total_flagged' can't be null";
        }
    ...
    {
        return $this->container['total_flagged'];
    }

    /**
     * Sets total_flagged
     *
     * @param float $total_flagged total_flagged
     *
     * @return $this
     */
    public function setTotalFlagged($total_flagged)
    {
        $this->container['total_flagged'] = $total_flagged;
