...
class PropertiesApi
{
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\Model\PropertyDto[], HTTP status code, HTTP response headers (array of strings)
     */
    public function callListWithHttpInfo()
    {
        $returnType = '\Swagger\Client\Model\PropertyDto[]';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Swagger\Client\Model\PropertyDto[]',
     ...
     * Create property
     *
     * @param  \Swagger\Client\Model\PropertyCreateDto $body body (required)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Swagger\Client\Model\PropertyDto
     ...
     * Create property
     *
     * @param  \Swagger\Client\Model\PropertyCreateDto $body (required)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\Model\PropertyDto, HTTP status code, HTTP response headers (array of strings)
    ...
    {
        $this->deleteWithHttpInfo($property_id);
    }
     ...
     */
    public function deleteWithHttpInfo($property_id)
    {
        $returnType = '';
        $request = $this->deleteRequest($property_id);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function deleteAsync($property_id)
    {
        return $this->deleteAsyncWithHttpInfo($property_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function deleteAsyncWithHttpInfo($property_id)
    {
        $returnType = '';
        $request = $this->deleteRequest($property_id);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function deleteRequest($property_id)
    {
        // verify the required parameter 'property_id' is set
        if ($property_id === null || (is_array($property_id) && count($property_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $property_id when calling delete'
            );
        }
     ...
     * @return \Swagger\Client\Model\PropertyDto
     */
    public function retrieve($property_id)
    {
        list($response) = $this->retrieveWithHttpInfo($property_id);
        return $response;
    }
     ...
     * @return array of \Swagger\Client\Model\PropertyDto, HTTP status code, HTTP response headers (array of strings)
     */
    public function retrieveWithHttpInfo($property_id)
    {
        $returnType = '\Swagger\Client\Model\PropertyDto';
        $request = $this->retrieveRequest($property_id);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function retrieveAsync($property_id)
    {
        return $this->retrieveAsyncWithHttpInfo($property_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function retrieveAsyncWithHttpInfo($property_id)
    {
        $returnType = '\Swagger\Client\Model\PropertyDto';
        $request = $this->retrieveRequest($property_id);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function retrieveRequest($property_id)
    {
        // verify the required parameter 'property_id' is set
        if ($property_id === null || (is_array($property_id) && count($property_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $property_id when calling retrieve'
            );
        }
     ...
     * Update property
     *
     * @param  \Swagger\Client\Model\PropertyUpdateDto $body body (required)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Swagger\Client\Model\PropertyDto
     ...
     * Update property
     *
     * @param  \Swagger\Client\Model\PropertyUpdateDto $body (required)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\Model\PropertyDto, HTTP status code, HTTP response headers (array of strings)
