...
class UnitsApi
{
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\Model\UnitDto[], HTTP status code, HTTP response headers (array of strings)
     */
    public function callListWithHttpInfo()
    {
        $returnType = '\Swagger\Client\Model\UnitDto[]';
     ...
     * Create unit
     *
     * @param  \Swagger\Client\Model\UnitCreateDto $body body (required)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Swagger\Client\Model\UnitDto
     ...
     * Create unit
     *
     * @param  \Swagger\Client\Model\UnitCreateDto $body (required)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\Model\UnitDto, HTTP status code, HTTP response headers (array of strings)
    ...
    {
        $this->deleteWithHttpInfo($unit_id);
    }
     ...
     */
    public function deleteWithHttpInfo($unit_id)
    {
        $returnType = '';
        $request = $this->deleteRequest($unit_id);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function deleteAsync($unit_id)
    {
        return $this->deleteAsyncWithHttpInfo($unit_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function deleteAsyncWithHttpInfo($unit_id)
    {
        $returnType = '';
        $request = $this->deleteRequest($unit_id);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function deleteRequest($unit_id)
    {
        // verify the required parameter 'unit_id' is set
        if ($unit_id === null || (is_array($unit_id) && count($unit_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $unit_id when calling delete'
            );
        }

        $resourcePath = '/units/{unitId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @return \Swagger\Client\Model\UnitDto
     */
    public function retrieve($unit_id)
    {
        list($response) = $this->retrieveWithHttpInfo($unit_id);
        return $response;
    }
     ...
     * @return array of \Swagger\Client\Model\UnitDto, HTTP status code, HTTP response headers (array of strings)
     */
    public function retrieveWithHttpInfo($unit_id)
    {
        $returnType = '\Swagger\Client\Model\UnitDto';
        $request = $this->retrieveRequest($unit_id);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function retrieveAsync($unit_id)
    {
        return $this->retrieveAsyncWithHttpInfo($unit_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function retrieveAsyncWithHttpInfo($unit_id)
    {
        $returnType = '\Swagger\Client\Model\UnitDto';
        $request = $this->retrieveRequest($unit_id);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function retrieveRequest($unit_id)
    {
        // verify the required parameter 'unit_id' is set
        if ($unit_id === null || (is_array($unit_id) && count($unit_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $unit_id when calling retrieve'
            );
        }
     ...
     * Update unit
     *
     * @param  \Swagger\Client\Model\UnitUpdateDto $body body (required)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Swagger\Client\Model\UnitDto
     ...
     * Update unit
     *
     * @param  \Swagger\Client\Model\UnitUpdateDto $body (required)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\Model\UnitDto, HTTP status code, HTTP response headers (array of strings)
