...
class AuthApi
{
    ...
    {
        list($response) = $this->tokenWithHttpInfo();
        return $response;
    }
     ...
     * @return array of \Swagger\Client\Model\LoginResponseDto, HTTP status code, HTTP response headers (array of strings)
     */
    public function tokenWithHttpInfo()
    {
        $returnType = '\Swagger\Client\Model\LoginResponseDto';
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function tokenAsync()
    {
        return $this->tokenAsyncWithHttpInfo()
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function tokenAsyncWithHttpInfo()
    {
        $returnType = '\Swagger\Client\Model\LoginResponseDto';
        $request = $this->tokenRequest();
